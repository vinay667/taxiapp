...
class _PlacesAutocompleteResult extends State<PlacesAutocompleteResult> {
  @override
  Widget build(BuildContext context) {
    final state = CustomAutoComplete.of(context);
    assert(state != null);
...
abstract class PlacesAutocompleteState extends State<CustomAutoComplete> {
...
class CustomAutocomplete {
  static Future<Prediction> show(
      {@required BuildContext context,
        ...
        Client httpClient,
        String startText=""}) {
    final builder = (BuildContext ctx) => CustomAutoComplete(
      apiKey: apiKey,
      mode: mode,
